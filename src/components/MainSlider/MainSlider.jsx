  ...
  {[ slide4, slide5, slide3].map((img , idx) => (
    <SwiperSlide key={idx}>
      <img  loading="lazy"
        src={img }
        alt={`slide-${idx}`}
        className="w-full h-[300px] object-cover md:h-[400px] lg:h-[500px]"
      />
    </SwiperSlide>
  ))}
</Swiper>
...
<div className="images  col-span-6 md:col-span-4  flex md:block   md:h-[400px] lg:h-[500px] ">
  <img  loading="lazy" src={slide1} alt="slide1" className='h-1/2  w-[100%]  object-fill'/>
  <img  loading="lazy" src={slide2} alt="slide2"  className='h-1/2 w-[100%] object-fill' />
